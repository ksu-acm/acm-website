        ...
        <Navbar className="navigation custom-nav" sticky="top" expand="lg" collapseOnSelect>
            <Container>
                <Navbar.Brand className="fw-bold">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/8/8e/Association_for_Computing_Machinery_%28ACM%29_logo.svg"
                ...
                <Navbar.Collapse>
                    <Nav className="ms-auto fw-bold fs-6">
                        ...
                        <Nav.Link as={Link} to="/meet">Meet Us</Nav.Link>
