...
function Members() {
    return(
      <Container fluid className="bg_members justify-content-center align-items-center">
        <div className='col row top-padding fw-bold text-white text-center'>
          ...
          <Container className="pb-4 text-white text-center">
            <div className="row mx-5">
              <div className="col-md">
                ...
                <h5 className="pt-3">Jose Lopez</h5>
          ...
          <Container className="bottom-padding text-white text-center">
            <div className="row mx-5">
              ...
              <div className="col-md">
                <img className="rounded-circle" src={laura} alt="logo" width="100px" height="100px" />
                <h5 className="pt-3">Laura Legg</h5>
